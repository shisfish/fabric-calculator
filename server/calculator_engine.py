...
DEFAULT_CATEGORIES = {
    "coat": {
        ...
        "pieces": [
            {"id": "front_body", "name": "前片", "default": True, "default_length": 62, "default_width": 37, "default_count": 2},
            {"id": "back_body", "name": "后片", "default": True, "default_length": 62, "default_width": 68, "default_count": 1},
            {"id": "big_sleeve", "name": "大袖片", "default": True, "default_length": 68.5, "default_width": 26, "default_count": 2},
            {"id": "small_sleeve", "name": "小袖片", "default": True, "default_length": 68.5, "default_width": 21, "default_count": 2},
            {"id": "collar", "name": "领子", "default": True, "default_length": 10, "default_width": 72.5, "default_count": 2},
            {"id": "turtle_patch", "name": "龟贴", "default": True, "default_length": 11.5, "default_width": 31, "default_count": 1},
            {"id": "facing", "name": "挂面", "default": True, "default_length": 67, "default_width": 25, "default_count": 2},
            {"id": "pocket_welt", "name": "袋贴", "default": True, "default_length": 17, "default_width": 10, "default_count": 2},
            {"id": "sleeve_tab", "name": "袖袢", "default": True, "default_length": 7, "default_width": 15.5, "default_count": 2},
            {"id": "belt", "name": "腰带", "default": True, "default_length": 8, "default_width": 149, "default_count": 1},
        ],
        "default_wastage": 8,
        "default_shrinkage": 3,
...
class FabricCalculator:
    ...
    def calculate_consumption(self, data):
        ...
        all_nesting_utils = []  # 收集所有材料的利用率，用于计算综合损耗率
        ...
        if total_area_cm2 > 0 and effective_fabric_width > 0:
            ...
            if theoretical_length > 0:
                ...
                calculated_wastage_rate = max(0, min(calculated_wastage_rate, 50))  # 限制在0-50%范围内
            else:
